...
/**
 * Generated class for the PopoverImageSellerPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-popover-image-seller',
  templateUrl: 'popover-image-seller.html',
})
export class PopoverImageSellerPage {
  data1:any;
  ...
  ionViewDidLoad() {
    this.photoSeller = this.navParams.data["0"].photo;
  }
