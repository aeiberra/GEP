...
@IonicPage()
@Component({
  selector: 'page-popover-image-price-list',
  templateUrl: 'popover-image-price-list.html',
})
export class PopoverImagePriceListPage {
  data1:any;
  ...
  ionViewDidLoad() {
    this.photoPriceList = this.navParams.data["0"].photo;
