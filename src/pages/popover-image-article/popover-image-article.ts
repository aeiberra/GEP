...
@IonicPage()
@Component({
  selector: 'page-popover-image-article',
  templateUrl: 'popover-image-article.html',
})
export class PopoverImageArticlePage {
  data1:any;
  ...
  ionViewDidLoad() {
    this.photoArticle = this.navParams.data["0"].photo;
  }
