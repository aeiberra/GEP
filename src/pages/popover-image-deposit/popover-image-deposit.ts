...
@IonicPage()
@Component({
  selector: 'page-popover-image-deposit',
  templateUrl: 'popover-image-deposit.html',
})
export class PopoverImageDepositPage {
  data1:any;
  ...
  ionViewDidLoad() {
    this.photoDeposit = this.navParams.data["0"].photo;
