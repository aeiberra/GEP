...
@IonicPage()
@Component({
  selector: 'page-popover-image-family',
  templateUrl: 'popover-image-family.html',
})
export class PopoverImageFamilyPage {
  data1:any;
  ...
  ionViewDidLoad() {
    this.photoFamily = this.navParams.data["0"].photo;
