...
/**
 * Generated class for the PopoverImageUserPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-popover-image-user',
  templateUrl: 'popover-image-user.html',
})
export class PopoverImageUserPage {
  data1:any;
  ...
  ionViewDidLoad() {
    this.photoUser = this.navParams.data["0"].photo;
  }
