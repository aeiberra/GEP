...
@IonicPage()
@Component({
  selector: 'page-popover-image-measure',
  templateUrl: 'popover-image-measure.html',
})
export class PopoverImageMeasurePage {
  data1:any;
  ...
  ionViewDidLoad() {
    this.photoMeasure = this.navParams.data["0"].photo;
