...
@IonicPage()
@Component({
  selector: 'page-popover-image-sales-rs',
  templateUrl: 'popover-image-sales-rs.html',
})
export class PopoverImageSalesRSPage {
  data1:any;
  ...
  ionViewDidLoad() {
    this.photoSalesRS = this.navParams.data["0"].photo;
