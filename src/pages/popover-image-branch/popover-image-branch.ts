...
/**
 * Generated class for the PopoverImageBranchPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-popover-image-branch',
  templateUrl: 'popover-image-branch.html',
})
export class PopoverImageBranchPage {
  data1:any;
  ...
  ionViewDidLoad() {
    this.photoBranch = this.navParams.data["0"].photo;
  }
